...
| 资产 | 下载地址 |
|---|---|
| Linux x86_64 | `https://github.com/scoltzero/msf/releases/download/v0.3.5/msf-linux-amd64.tar.gz` |
| Linux ARM64 | `https://github.com/scoltzero/msf/releases/download/v0.3.5/msf-linux-arm64.tar.gz` |
| fnOS x86 FPK | `https://github.com/scoltzero/msf/releases/download/v0.3.5/msf_0.3.5_x86.fpk` |
| fnOS ARM FPK | `https://github.com/scoltzero/msf/releases/download/v0.3.5/msf_0.3.5_arm.fpk` |
| Unraid PLG | `https://github.com/scoltzero/msf/releases/download/v0.3.5/msf.plg` |
