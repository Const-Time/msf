...
| 架构 | 下载地址 |
|---|---|
| x86_64 / amd64 | `https://github.com/scoltzero/msf/releases/download/v0.3.5/msf-linux-amd64.tar.gz` |
| ARM64 / aarch64 | `https://github.com/scoltzero/msf/releases/download/v0.3.5/msf-linux-arm64.tar.gz` |
