...
这个实验镜像不会推送到 `latest`。拉取或部署 Docker 实验版时必须显式写出 `v0.3.6-docker.1` tag。
...
- 镜像：`ghcr.io/scoltzero/msf:v0.3.6-docker.1`
- 网络：`host`
...
2. 新建容器，镜像填写 `ghcr.io/scoltzero/msf:v0.3.6-docker.1`。
...
| 变量 | 默认值 | 用途 |
|---|---|---|
| `MSF_IMAGE` | `ghcr.io/scoltzero/msf:v0.3.6-docker.1` | 容器镜像 |
